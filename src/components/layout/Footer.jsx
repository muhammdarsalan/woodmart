      ...
      <div className="max-w-7xl mx-auto px-4 py-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        <div>
          ...
          <div className="flex gap-3">
            ...
            <a href="https://wa.me/923000000000" className="p-2 border border-gold/25 rounded text-white/45 hover:border-gold hover:text-gold transition-colors" aria-label="WhatsApp">
